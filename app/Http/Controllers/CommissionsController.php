...
class CommissionsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $perPage = 25;
        $query  = Commission::query()->with(['payouts']);
        if (!empty($keyword)) {
        ...
        $commissionsItems = $query->latest()->paginate($perPage);
        $commissions = CommissionResource::collection($commissionsItems);
        return Inertia::render('AdminCommissions/Index', compact('commissions'));
    }
    ...
    {
        return Inertia::render('AdminCommissions/Create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('commissions.index')->with('success', 'Commission rebuilt!');
    }
    ...
    public function show(Request $request, Commission $commission)
    {
        ...
        return Inertia::render('AdminCommissions/Show', [
    ...
    {
        $commission->load(['payouts']);
        return Inertia::render('AdminCommissions/Edit', [
            'commission' => new CommissionResource($commission)
        ]);
    }
