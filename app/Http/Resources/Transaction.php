...
class Transaction extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'isWithdraw' =>  $this->transactable && get_class($this->transactable) ==  WithdrawModel::class,
            'isDeposit' =>  $this->transactable && get_class($this->transactable) ==  DepositModel::class,
            'isStake' => $this->transactable && get_class($this->transactable) ==  StakeModel::class,
            'isTicket' => $this->transactable && get_class($this->transactable) ==  TicketModel::class,
            'isPayout' => $this->transactable && get_class($this->transactable) ==  PayoutModel::class,
