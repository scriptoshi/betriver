<script setup>
	...
	const form = useForm({
		user_id: props.connection.user_id,
		provider: props.connection.provider,
		userId: props.connection.userId,
	});
	const save = () =>
		form.put(window.route("connections.edit", props.connection.id));
</script>
<template>
	<AdminLayout>
		<Head :title="title ?? `Edit Connection`" />
		<main class="h-full">
			<div
				...
				<div class="flex flex-col gap-4 h-full">
					<div
						...
						<div class="mb-4 lg:mb-0">
							<h3 class="h3">Edit Connection</h3>
						</div>
						<div
