...
const form = useForm({
		user_id:props.personal.user_id,
		proof_of_identity:props.personal.proof_of_identity,
		proof_of_identity_type:props.personal.proof_of_identity_type,
		proof_of_address:props.personal.proof_of_address,
		proof_of_address_type:props.personal.proof_of_address_type,
		...
		time_out_at:props.personal.time_out_at,
		dob:props.personal.dob
});
const save = () => form.put(window.route("personals.edit",props.personal.id));
</script>
<template>
    <AdminLayout>
        <Head :title="title ?? `Edit Personal` " />
        <main class="h-full">
                ...
                <div class="flex flex-col gap-4 h-full">
                    <div class="lg:flex items-center justify-between mb-4 gap-3">
                        <div class="mb-4 lg:mb-0">
                            <h3 class="h3">Edit Personal</h3>
                        </div>
                        <div class="flex flex-col lg:flex-row lg:items-center gap-3">
                            <Link :href="route('admin.personals.index')"
					...
					{{ timeAgo }}
                                ...
                                <div class="pt-12">
                                    <div class="flex justify-end">
                                        <PrimaryButton as="button" :href="route('admin.personals.index')"
