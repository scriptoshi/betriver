...
const type = computed({
    get: () => props.type,
    set: (val) =>
        router.visit(window.route("admin.commissions.index", { type: val })),
});
                    ...
                    <div class="card border-0 card-border">
                        <div class="card-body px-0 card-gutterless h-full">
                            ...
                            <div>
                                ...
                                <Pagination :meta="commissions.meta" />
                            </div>
                        </div>
                    </div>
                </div>
