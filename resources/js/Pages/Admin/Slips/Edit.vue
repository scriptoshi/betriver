<script setup>
	...
	const form = useForm({
		user_id: props.slip.user_id,
		uid: props.slip.uid,
		amount: props.slip.amount,
		payout: props.slip.payout,
		total_odds: props.slip.total_odds,
	});
	const save = () => form.put(window.route("slips.edit", props.slip.id));
</script>
<template>
	<AdminLayout>
		<Head :title="title ?? `Edit Slip`" />
		<main class="h-full">
			<div
				...
				<div class="flex flex-col gap-4 h-full">
					<div
						...
						<div class="mb-4 lg:mb-0">
							<h3 class="h3">Edit Slip</h3>
						</div>
						<div
							class="flex flex-col lg:flex-row lg:items-center gap-3">
							<Link
								:href="route('admin.slips.index')"
