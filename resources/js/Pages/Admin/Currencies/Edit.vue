...
const form = useForm({
		gateway:props.currency.gateway,
		code:props.currency.code,
		name:props.currency.name,
		regex:props.currency.regex,
		logo_url:props.currency.logo_url,
		chain:props.currency.chain,
		contract:props.currency.contract,
		explorer:props.currency.explorer
});
const save = () => form.put(window.route("currencies.edit",props.currency.id));
</script>
<template>
    <AdminLayout>
        <Head :title="title ?? `Edit Currency` " />
        <main class="h-full">
                ...
                <div class="flex flex-col gap-4 h-full">
                    <div class="lg:flex items-center justify-between mb-4 gap-3">
                        ...
                        <div class="flex flex-col lg:flex-row lg:items-center gap-3">
                            ...
                            {{ $t("Go Back to currencies list") }}</Link>
                        </div>
                    </div>
                            ...
                            <form @submit.prevent="save" class="container lg:w-4/5">
                                ...
                                <div class="pt-12">
                                    <div class="flex justify-end">
                                        <PrimaryButton as="button" :href="route('admin.currencies.index')"
